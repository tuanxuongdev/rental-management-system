...
### Purpose
Support the complete move in task with clear context, guarded actions, and durable outcomes.
...
### Breadcrumb
`Leasing / Move In`; detail/workflow screens insert the authorized parent label and record identifier. Breadcrumbs never contain sensitive values.
