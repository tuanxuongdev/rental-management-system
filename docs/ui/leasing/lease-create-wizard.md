...
### Purpose
Create a complete Draft Lease with parties, Rentable Item, terms, deposit, billing, documents, and final review.
...
### Breadcrumb
`Leasing / Lease Create Wizard`; detail/workflow screens insert the authorized parent label and record identifier. Breadcrumbs never contain sensitive values.
...
```mermaid
flowchart LR
  A[Authorized entry] --> B[Lease Create Wizard]
