...
### Purpose
Create or update Notification Template with validation, impact preview, and safe concurrency handling.
...
### Breadcrumb
`Communications / Notification Template Editor`; detail/workflow screens insert the authorized parent label and record identifier. Breadcrumbs never contain sensitive values.
...
```mermaid
flowchart LR
  A[Authorized entry] --> B[Notification Template Editor]
