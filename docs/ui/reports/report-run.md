...
### Purpose
Configure and launch a governed asynchronous report with visible scope, as-of context, purpose, and expiry.
...
### Breadcrumb
`Reports / Report Run`; detail/workflow screens insert the authorized parent label and record identifier. Breadcrumbs never contain sensitive values.
...
```mermaid
flowchart LR
  A[Authorized entry] --> B[Report Run]
