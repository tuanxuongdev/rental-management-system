...
### Purpose
Support the complete reports catalog task with clear context, guarded actions, and durable outcomes.
...
### Breadcrumb
`Reports / Reports Catalog`; detail/workflow screens insert the authorized parent label and record identifier. Breadcrumbs never contain sensitive values.
...
```mermaid
flowchart LR
  A[Authorized entry] --> B[Reports Catalog]
...
### Field list
The primary record is read-oriented; filters, inline notes, and permitted quick actions remain forms. Fields and filter controls: Report definition; Property scope; as-of/period; time zone; currency; format; purpose; schedule; recipients; expiry.
